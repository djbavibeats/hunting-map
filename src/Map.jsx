...
const ButtonsBlock = ({ activeScreen, setActiveScreen }) => {
    return (
        <div className="flex flex-wrap items-center justify-center md:flex-col gap-4">
            ...
            >
                <div className="mt-[1.75px]"><p className="font-tungsten">SETLIST</p></div> 
...
const TourBlock = () => {
    ...
    ">
        <img className="w-full max-w-[536px]" src={ TourHeader } />
...
const SetlistBlock = () => {
    ...
    return (<div className="
        w-[350px] max-w-[100%] h-full p-4
        md:w-full md:col-span-5
        flex flex-col items-center justify-between bg-black gap-y-4 pb-8
    ">
        {/* <img className="w-[350px]" src={ StigmaAlbumCover } /> */}
        <p className="text-yellow text-center font-tungsten text-[2.5rem] tracking-wide w-full">WAGE WAR SETLIST</p>
        <iframe 
        style={{ borderRadius: `0px`, maxWidth: `500px` }}
        src="https://open.spotify.com/embed/playlist/37i9dQZF1DZ06evO3EgOQ0?utm_source=generator&theme=0" 
        ...
        >
            <div className="mt-[1.75px]"><p className="font-tungsten">SAVE NOW</p></div> 
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 448 512">
...
function Map ({ user }) {
    ...
    return (<>
        <div className="
            ...
            ">
                <div className="md:hidden col-span-3 flex flex-col justify-center items-center md:-order-1">
                    <HeaderBlock />
                </div>
